...
FILES = [
    ...
    *sorted((ROOT/'scenarios').glob('*.json')),
    ...
    ROOT/'tools/pf_action_data_binding_probe.py',
    ROOT/'tools/pf_action_data_binding_probe_config.json',
    ROOT/'tools/pf_action_data_binding_probe_local_config.json',
