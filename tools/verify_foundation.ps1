...
py -3 -m py_compile tools\pf_action_data_binding_probe.py
Assert-NativeSuccess -ExitCode $LASTEXITCODE -Step 'action data binding probe py_compile'
...
expected = {
    ...
    'tools/pf_action_data_binding_probe.py',
    'tools/pf_action_data_binding_probe_config.json',
    'tools/pf_action_data_binding_probe_local_config.json',
