...
expected = {
    ...
    'src/pirateforce_foundation/connection.py',
    ...
    'src/pirateforce_foundation/item_move_capture.py',
    'src/pirateforce_foundation/second_password_bypass.py',
    'src/pirateforce_foundation/item_move_hypothesis.py',
