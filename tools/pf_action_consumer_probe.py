...
function step(tid,want){{const s=state(tid);if(!s||s.step!==want){{emit('probe_error',{{reason:'sequence or thread correlation failure'}});return null;}}return s;}}
