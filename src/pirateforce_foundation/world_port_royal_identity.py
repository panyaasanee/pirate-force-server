...
class SceneIdentity:
    ...
    name: str
    title: str
    # Appended rather than put where the sibling scenes put it: this class is
    # built with ``SceneIdentity(*row)``, so a field inserted in the middle
    # would silently re-map every row instead of failing.
    level: int


# (Mob-Set number, MOBS.n_ID, MOBS.s_OUTFIT, MOBS_TIP.s_NAME, MOBS_TIP.s_TITLE,
#  MOBS.n_LEVEL_MIN)
# LEVEL ADDED round `7ste68` (LANE-A).  The first draft of that round wrote
# that this scene "has no mined level column at all" and skipped it, leaving
# Port Royal the one live census source still sending no level.  pf-adversary
# refuted that inside the same round by doing the join: all 105 rows below
# carry a real MOBS.n_ID, and every one of them resolves in the shipped
# CONSTDATA_TH__MOBS table, so the column was one join away rather than
# absent.  Mined from the same table and the same column every sibling
# scene's identity module mined its own from (n_LEVEL_MIN, the floor of the
# row's range; 53 of these 105 rows have n_LEVEL_MAX above it, and nothing in
# this project has measured how the original server rolled inside that range,
# so the floor is what is sent -- see world_census_level's own docstring).
...
_RESOLVED_ROWS = (
    (2, 156, 'M055_000_000_N', 'Columbus', 'Marine Transport Station', 10),
    (3, 157, 'M071_000_002_N', 'Love Millie', 'Antique Store', 10),
    (4, 158, 'M071_000_001_SP2', 'Dorothy', '', 10),
    (5, 159, 'P_MALE_002_001_FRANK', 'Hields', 'Guild Administrator', 10),
    (6, 160, 'P_MALE_002_001_FRANK', 'Frank', 'Port Royal Congressman', 10),
    (7, 161, 'M068_000_002_N', 'Locher', 'Finance Administrator', 10),
    (8, 162, 'P_MALE_009_002_JOSHUA', 'Joshua', 'Appraisers', 10),
    (9, 163, 'P_MALE_001_001_MIKEY', 'Mackie', 'Royal Exchange Manager', 10),
    (10, 164, 'P_MALE_008_002_NAYA', 'Nayar', 'Skill Trainer', 10),
    (11, 165, 'P_MALE_003_003_TIM', 'Tim', 'Dungeon Keeper', 10),
    (12, 166, 'M072_000_002_N', 'Grace', 'Beer Promoter Girl', 10),
    (13, 167, 'P_MALE_010_000_JAMSON', 'Jensen', 'Shipyard Engineer', 10),
    (14, 168, 'M052_000_000_N', 'Nelson', 'Royal Navy Admiral', 15),
    (15, 169, 'M056_000_000_N', 'Bismarck', 'Admiral', 10),
    (16, 170, 'M057_000_000_N', 'Isoroku Yamamoto', 'Admiral', 10),
    (17, 171, 'M070_000_000_N', 'Drunkard Captain', 'Sea Watchers', 10),
    (18, 172, 'M015_000_000_SP3', 'Mo Yuzi', 'Naval Communications Bureau', 10),
    (19, 173, 'P_MALE_007_001_ANDERSON', 'Anderson', 'Antiquities Trader', 10),
    (20, 174, 'M024_001_000_N', 'Clark', 'Navy Lieutenant Colonel', 10),
    (21, 175, 'P_MALE_007_000_WILLS', 'Willes', 'Minister Palace', 10),
    (22, 176, 'M051_000_000_N', 'Rosemary', 'Princess', 10),
    (23, 177, 'M019_000_001_N', 'Lisa', 'Navy Transport Officer', 10),
    (24, 178, 'P_MALE_002_000_NEO', 'Neo', 'Treasure Hunters Assistant', 10),
    (25, 179, 'M071_001_000_SP3', 'Seafood Businesswoman', '', 10),
    (26, 180, 'P_FEMALE_012_002_DAZZY', 'Daisy', 'Beautiful Wife', 10),
    (27, 181, 'P_MALE_001_002_FEMANDEZ', 'Fernandez', 'Aristocratic Gentleman', 16),
    (28, 182, 'P_MALE_005_000_STRANGER', 'Mysterious Stranger', '', 16),
    (29, 183, 'M055_000_000_N', 'Columbus', 'Dream Voyager', 16),
    (30, 247, 'P_MALE_002_003_JOSEPH', 'Josef', 'Young Master', 16),
    (31, 248, 'P_MALE_018_000_DAVINCI', 'Da Vinci', 'World Artist', 16),
    (32, 356, 'M069_000_000_N', 'Jim', 'Pirates Fan Boy', 10),
    (33, 357, 'M069_000_001_N', 'Jill', 'Pirates Fan Boy', 10),
    (34, 358, 'M068_000_000_SP1', 'Babu', 'Strong Sailor', 10),
    (35, 359, 'P_MALE_004_000_N', 'Deserter Navy', '', 10),
    (36, 622, 'P_FEMALE_007_001_APPLE', 'Elbow', 'Safe Keeper', 105),
    (37, 623, 'M070_000_002_N', 'George', 'Redeem Officer', 105),
    (38, 624, 'M070_000_000_N', 'Toby', 'Heaven Officer', 105),
    (39, 625, 'M010_000_000_SP2', 'Paul', 'Ocean Navy ', 105),
    (40, 626, 'P_FEMALE_005_001_SECILIA', 'Cecilia', "Maritime King's Daughter", 105),
    (41, 627, 'P_MALE_017_000_SILVER', 'Silva', 'Heroic Captain', 105),
    (42, 631, 'P_MALE_004_001_PALACEGUARD', 'Palace Lifeguard', '', 120),
    (43, 631, 'P_MALE_004_001_PALACEGUARD', 'Palace Lifeguard', '', 120),
    (44, 631, 'P_MALE_004_001_PALACEGUARD', 'Palace Lifeguard', '', 120),
    (45, 632, 'P_FEMALE_004_001_PRINCESSGUARD', 'Princess Guard', '', 125),
    (46, 632, 'P_FEMALE_004_001_PRINCESSGUARD', 'Princess Guard', '', 125),
    (47, 633, 'P_MALE_004_000_SP1', 'Navy Headquarters Guard', '', 105),
    (48, 633, 'P_MALE_004_000_SP1', 'Navy Headquarters Guard', '', 105),
    (49, 635, 'M001_003_001_SP2', 'Leo', 'The Wolf Bounty', 105),
    (50, 636, 'M019_003_000_N', 'Monica', 'Marksman Huntress', 105),
    (51, 637, 'INVISIBLE', 'Bermuda Crack', '', 120),
    (52, 638, 'BULLETIN_BOARD', 'Port Royal Bulletin Board', '', 105),
    (53, 639, 'P_MALE_001_003_BARBAROSA', 'Barbarossa', 'Maritime Presidency', 105),
    (54, 717, 'P_FEMALE_007_000_ERIA', 'Jenny', 'Smelter', 86),
    (55, 151, 'MAP001_000_000', 'Mirage reel', '', 105),
    (56, 152, 'BULLETIN_BOARD', 'Harbor Bulletin 1', '', 105),
    (57, 153, 'BULLETIN_BOARD', 'Harbor Bulletin 2', '', 105),
    (58, 154, 'BULLETIN_BOARD', 'Harbor Bulletin 3', '', 105),
    (59, 740, 'P_MALE_012_002_FRIEND', 'Romeo', 'Modern Lover', 10),
    (60, 741, 'P_FEMALE_012_002_FRIEND', 'Juliet', 'Sworn', 10),
    (61, 796, 'P_MALE_002_001_SARS', 'Sase', 'Guild Assistant', 105),
    (62, 797, 'P_MALE_003_001_JONATHAN', 'Jonathan', 'Strengthen Master', 10),
    (63, 798, 'P_FEMALE_002_000_MIX', 'Micks', 'Integration Master', 10),
    (64, 799, 'P_FEMALE_009_000_KELLY', 'Kailey', 'Smelting Master', 10),
    (65, 800, 'P_MALE_004_000_RIMERD', 'Remad', 'Refining Master', 10),
    (66, 801, 'P_MALE_010_001_ADAM', 'Adam', 'Royal Navy Engineer', 10),
    (67, 802, 'P_MALE_010_001_ROY', 'Loie', 'Royal Navy Engineer', 10),
    (68, 803, 'P_MALE_004_001_PALACEGUARD', 'Palace Lifeguard', 'Unconscious', 10),
    (69, 804, 'P_MALE_007_000_WILLS', 'Willes', 'Panic Lord', 10),
    (70, 805, 'P_MALE_009_000_ROBEN', 'Lupin', 'Strange Pirate', 10),
    (71, 767, 'P_FEMALE_002_003_NIGHTINGALE', 'Nightingale', 'Nursing', 10),
    (72, 815, 'M001_000_000_N', 'Bluebeard Barney', 'Unemployed Crew', 10),
    (73, 816, 'M024_000_001_N', 'Coruno', 'Sergeant Major vanguard', 10),
    (74, 817, 'M001_002_000_N', 'Jinbada', 'Eastern Wolf', 10),
    (75, 818, 'M010_001_000_N', 'Bear', 'Gutman', 10),
    (77, 820, 'M026_001_001_N', 'Caribbean', 'Curse Captain ', 10),
    (78, 821, 'M017_000_003_N', 'Divinity', 'Barbarian', 10),
    (79, 822, 'M015_001_000_N', 'meow', 'Adventure Cat', 10),
    (80, 827, 'P_MALE_009_000_ROBEN', 'Lupin', 'Strange Pirate', 10),
    (81, 828, 'M079_000_000_N', 'Ophelia', 'Death Girl', 10),
    (82, 833, 'M070_000_002_N', 'Brin', 'Gold Shop', 105),
    (83, 834, 'M023_000_000_SP1', 'San Marco', 'Sky Dragon Trader', 105),
    (84, 882, 'M055_001_000_N', 'Magellan', '', 40),
    (85, 871, 'P_MALE_014_000_COLSON', 'Agent Coulson', '', 10),
    (88, 899, 'P_FEMALE_002_001_PET_LORD', 'Aisha', 'Herdsman', 10),
    (89, 902, 'P_MALE_010_000_STRONG', 'Wang Willie', 'Chocolate Factory Owner', 10),
    (90, 903, 'M071_000_001_SP1', 'Melody', 'Grocer', 10),
    (91, 904, 'P_MALE_002_002_SALEY', 'Chalais', 'Illustrations Appraisers', 10),
    (92, 905, 'P_MALE_005_000_BENFRIO', 'Benfolio', '\u0e23\u0e49\u0e32\u0e19\u0e1e\u0e31\u0e19\u0e18\u0e21\u0e34\u0e15\u0e23', 10),
    (93, 909, 'P_MALE_004_000_SP1', 'Strand', 'PVP Shop', 10),
    (94, 910, 'P_MALE_004_000_N', 'Saben', 'Onboard Engineer', 10),
    (95, 911, 'P_FEMALE_002_001_PET_LORD', 'Mysterious Stranger', '', 10),
    (96, 913, 'P_MALE_012_000_FRAG', 'Fraga', 'Fragment Changer', 10),
    (97, 916, 'M016_000_000_N', 'Training Iron Man', '', 100),
    (98, 917, 'INVISIBLE', '', '', 100),
    (99, 918, 'M071_000_000_SP2', 'Vera', 'Nutrition Jelly Shop', 10),
    (100, 920, 'M074_000_000_N', 'Hemingway', 'Strange Fishing', 10),
    (102, 634, 'M024_000_000_N', 'Navy Private', 'Navy Patrol', 25),
    (103, 917, 'INVISIBLE', '', '', 100),
    (104, 897, 'P_MALE_010_000_STRONG', 'Alienation Big Wolf', '', 10),
    (105, 928, 'P_MALE_012_010_DETACTIVE', 'Hired Detective', 'Hard work', 10),
    (106, 929, 'P_MALE_010_000_JAMSON', 'Jensen', 'Lying on the ground', 10),
    (107, 930, 'INVISIBLE', 'Suspicious Ship', '', 120),
    (108, 933, 'M024_000_000_SP1', 'Apple', 'Ultimate Bodyguard', 10),
    (109, 855, 'M008_000_003_SP3', 'Jack', 'Pumpkin Demon King', 10),
    (111, 934, 'P_FEMALE_007_002_KLEITA', 'Keleita', '\u0e23\u0e49\u0e32\u0e19\u0e40\u0e2a\u0e37\u0e49\u0e2d\u0e1c\u0e49\u0e32', 10),
)
