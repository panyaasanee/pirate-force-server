...
AI_COMBAT_ROWS = {
    100: ('DISTANCE_ENEMY>(700);BUFF_I(4985,0,0)\\nDISTANCE_ENEMY<(701);RATE(40)\\nDISTANCE_ENEMY<(500);KD_ENEMY(1);RATE(90)\\nDISTANCE_ENEMY<(500);RATE(10);BUFF_I(4981,0,0);HP_I<(0.5)\\nGO(0)',
         'CHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(4)\\nCHASE(1)'),
    102: ('DISTANCE_ENEMY>(700);BUFF_I(4985,0,0)\\nDISTANCE_ENEMY<(701);RATE(30)\\nDISTANCE_ENEMY<(500);KD_ENEMY(1);RATE(90)\\nDISTANCE_ENEMY<(500);RATE(30);BUFF_I(4981,0,0);HP_I<(0.7)\\nGO(0)',
         'CHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(4)\\nCHASE(1)'),
    111: ('DISTANCE_ENEMY>(600);RATE(50);BUFF_I(4980,0,0)\\nRATE(30)\\nDISTANCE_ENEMY<(500);RATE(20);BUFF_I(4981,0,0)\\nDISTANCE_ENEMY<(500);RATE(20);BUFF_I(4981,0,0)\\nHP_I<(0.7);RATE(30);BUFF_I(4990,0,0)\\nDISTANCE_ENEMY<(500);RATE(5)\\nGO(0)',
         'CHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(4)\\nCHASE(5)\\nCHASE(3)\\nCHASE(1)'),
    121: ('DISTANCE_ENEMY>(700);BUFF_I(4986,0,0);RATE(30)\\nHP_I<(0.75);BUFF_I(4984,0,0);RATE(10)\\nDISTANCE_ENEMY<(700);BUFF_I(4985,0,0);RATE(40)\\nDISTANCE_ENEMY<(700);BUFF_I(4981,0,0);RATE(15)\\nGO(0)',
         'CHASE(2)\\nCHASE(5)\\nCHASE(4)\\nCHASE(3)\\nCHASE(1)'),
    123: ('DISTANCE_ENEMY>(700);BUFF_I(4986,0,0);RATE(30)\\nDISTANCE_ENEMY<(700);BUFF_I(4985,0,0);RATE(40)\\nDISTANCE_ENEMY<(700);BUFF_I(4981,0,0);RATE(15)\\nGO(0)',
         'CHASE(2)\\nCHASE(4)\\nCHASE(3)\\nCHASE(1)'),
    125: ('BUFF_I(4984,0,0);HP_I<(0.7);RATE(30)\\nDISTANCE_ENEMY>(700);BUFF_I(4986,0,0);RATE(30)\\nDISTANCE_ENEMY<(700);BUFF_I(4985,0,0);RATE(40)\\nDISTANCE_ENEMY<(700);BUFF_I(4981,0,0);RATE(10)\\nBUFF_I(3008,0,1)\\nGO(0)',
         'CHASE(5)\\nCHASE(2)\\nCHASE(4)\\nCHASE(3)\\nCHASE(6)\\nCHASE(1)'),
    ...
    140: ('DISTANCE_ENEMY>(500);HP_I<(0.5);BUFF_I(4981,0,0);RATE(8)\\nDISTANCE_ENEMY>(500);RATE(20)\\nGO(0)',
         'CHASE(3)\\nCHASE(2)\\nCHASE(1)'),
    142: ('DISTANCE_ENEMY>(500);HP_I<(0.8);BUFF_I(4981,0,0);RATE(30)\\nDISTANCE_ENEMY>(500);RATE(60)\\nGO(0)',
         'CHASE(3)\\nCHASE(2)\\nCHASE(1)'),
    162: ('HP_I<(0.5);BUFF_I(4984,0,0);RATE(15)\\nDISTANCE_ENEMY>(400);BUFF_I(4980,0,0);RATE(40)\\nRATE(20)\\nHP_I<(0.5);RATE(7)\\nGO(0)',
         'CHASE(3)\\nCHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(1)'),
    182: ('KD_ENEMY(1);DISTANCE_ENEMY<(300);RATE(70)\\nRATE(20)\\nHP_I<(0.7);RATE(40)\\nHP_I<(0.7);BUFF_I(4981,0,0);RATE(40)\\nHP_I<(0.7);DISTANCE_ENEMY<(800);BUFF_I(4984,0,0);RATE(15)\\nGO(0)',
         'CHASE(4)\\nCHASE(1)\\nCHASE(2)\\nCHASE(3)\\nCHASE(5)\\nCHASE(1)'),
    ...
    240: ('DISTANCE_ENEMY>(400);RATE(95)\\nDISTANCE_ENEMY<(450);RATE(60)\\nGO(0)',
         'CHASE(2)\\nCHASE(2)\\nCHASE(1)'),
    250: ('RATE(45)\\nRATE(60)\\nBUFF_I(4983,0,0);HP_I<(0.5);RATE(10)\\nGO(0)',
         'CHASE(1)\\nCHASE(2)\\nCHASE(3)\\nCHASE(1)'),
    261: ('BUFF_I(4982,0,0);RATE(15)\\nBUFF_I(4982,0,0);HP_I<(0.7);RATE(30)\\nRATE(25)\\nBUFF_I(4980,0,0);DISTANCE_ENEMY>(500);RATE(50)\\nGO(0)',
         'CHASE(3)\\nCHASE(3)\\nCHASE(1)\\nCHASE(2)\\nCHASE(1)'),
    273: ('HP_I>(0.7);RATE(30)\\nBUFF_I(4984,0,0);HP_I>(0.5);HP_I<(0.7);RATE(30)\\nBUFF_I(4984,0,0);HP_I<(0.5);RATE(30)\\nDISTANCE_ENEMY>(400);BUFF_I(4980,0,0);RATE(50)\\nBUFF_I(4983,0,0);HP_I<(0.8);RATE(20)\\nBUFF_I(4981,0,0);HP_I<(0.6);RATE(20)\\nHP_I<(0.5);RATE(15)\\nGO(0)',
         'CHASE(1)\\nCHASE(5)\\nCHASE(6)\\nCHASE(2)\\nCHASE(4)\\nCHASE(3)\\nCHASE(3)\\nCHASE(1)'),
    280: ('HP_I<(0.5);BUFF_I(4982,0,0);RATE(15)\\nDISTANCE_ENEMY<(500);RATE(40)\\nGO(0)',
         'CHASE(3)\\nCHASE(1)\\nCHASE(2)'),
    293: ('KD_ENEMY(1);DISTANCE_ENEMY<(200);RATE(80)\\nRATE(20)\\nBUFF_I(4983,0,0);HP_ALLY<(0.7);RATE(50)\\nHP_I>(0.8);RATE(20)\\nBUFF_I(4982,0,0);HP_I<(0.9);RATE(50)\\nHP_I>(0.6);RATE(20)\\nHP_I<(0.5);RATE(30)\\nBUFF_I(4987,0,0);HP_I<(0.7);RATE(30)\\nGO(0)',
         'CHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(1)\\nCHASE(5)\\nCHASE(1)\\nCHASE(5)\\nCHASE(4)\\nCHASE(1)'),
    ...
    301: ('HP_I<(0.3);RATE(15)\\nBUFF_I(4983,0,0);HP_I<(0.4);RATE(10)\\nBUFF_I(4982,0,0);DISTANCE_ENEMY<(750);RATE(35)\\nBUFF_I(4980,0,0);DISTANCE_ENEMY>(300);RATE(75)\\nGO(0)',
         'CHASE(5)\\nCHASE(4)\\nCHASE(3)\\nCHASE(2)\\nCHASE(1)'),
    320: ('DISTANCE_ENEMY>(300);RATE(50)\\nBUFF_I(4982,0,0);HP_I<(0.5);DISTANCE_ENEMY<(600);RATE(10)\\nGO(0)',
         'CHASE(2)\\nCHASE(3)\\nCHASE(1)'),
    ...
    352: ('BUFF_I(4986,0,0);DISTANCE_ENEMY<(800);RATE(20)\\nBUFF_I(4981,0,0);BUFF_I(4983,0,0);HP_I<(0.7);RATE(30)\\nBUFF_I(4980,0,0);DISTANCE_ENEMY>(400);RATE(80)\\nDISTANCE_ENEMY<(275);RATE(80)\\nGO(0)',
         'CHASE(4)\\nCHASE(3)\\nCHASE(2)\\nCHASE(1)\\nCHASE(1)'),
    360: ('RATE(30)\\nBUFF_I(4980,0,0);RATE(20)\\nBUFF_I(4988,0,0);HP_I<(0.5);RATE(15)\\nGO(0)',
         'CHASE(1)\\nCHASE(2)\\nCHASE(3)\\nCHASE(1)'),
    362: ('BUFF_I(4988,0,0);RATE(20)\\nBUFF_I(4980,0,0);RATE(40)\\nBUFF_I(4984,0,0);HP_I<(0.6);RATE(25)\\nGO(0)',
         'CHASE(3)\\nCHASE(2)\\nCHASE(5)\\nCHASE(1)'),
