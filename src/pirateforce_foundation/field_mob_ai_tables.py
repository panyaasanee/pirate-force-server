...
AI_COMBAT_ROWS = {
    ...
    102: ('DISTANCE_ENEMY>(700);BUFF_I(4985,0,0)\\nDISTANCE_ENEMY<(701);RATE(30)\\nDISTANCE_ENEMY<(500);KD_ENEMY(1);RATE(90)\\nDISTANCE_ENEMY<(500);RATE(30);BUFF_I(4981,0,0);HP_I<(0.7)\\nGO(0)',
         'CHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(4)\\nCHASE(1)'),
    110: ('DISTANCE_ENEMY>(600);RATE(50);BUFF_I(4980,0,0)\\nRATE(60)\\nDISTANCE_ENEMY<(500);RATE(10);BUFF_I(4981,0,0)\\nDISTANCE_ENEMY<(500);RATE(10);BUFF_I(4981,0,0)\\nGO(0)',
         'CHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(4)\\nCHASE(1)'),
    ...
    142: ('DISTANCE_ENEMY>(500);HP_I<(0.8);BUFF_I(4981,0,0);RATE(30)\\nDISTANCE_ENEMY>(500);RATE(60)\\nGO(0)',
         'CHASE(3)\\nCHASE(2)\\nCHASE(1)'),
    150: ('BUFF_I(4980,0,0);RATE(30)\\nBUFF_I(4980,0,0);RATE(50)\\nGO(0)',
         'CHASE(2)\\nCHASE(3)\\nCHASE(1)'),
    162: ('HP_I<(0.5);BUFF_I(4984,0,0);RATE(15)\\nDISTANCE_ENEMY>(400);BUFF_I(4980,0,0);RATE(40)\\nRATE(20)\\nHP_I<(0.5);RATE(7)\\nGO(0)',
         'CHASE(3)\\nCHASE(2)\\nCHASE(1)\\nCHASE(3)\\nCHASE(1)'),
    164: ('HP_I<(0.5);BUFF_I(4984,0,0);RATE(15)\\nDISTANCE_ENEMY>(400);BUFF_I(4980,0,0);RATE(60)\\nRATE(60)\\nHP_I<(0.5);BUFF_I(4988,0,0);DISTANCE_ENEMY<(500);RATE(10)\\nGO(0)',
         'CHASE(3)\\nCHASE(2)\\nCHASE(1)\\nCHASE(4)\\nCHASE(1)'),
    ...
    201: ('RATE(10)\\nDISTANCE_ENEMY<(400);BUFF_I(4982,0,0);RATE(50)\\nHP_I<(0.8);BUFF_I(4982,0,0);RATE(20)\\nDISTANCE_ENEMY<(400);RATE(40)\\nGO(0)',
         'CHASE(1)\\nCHASE(3)\\nCHASE(3)\\nCHASE(1)\\nCHASE(2)'),
    210: ('RATE(10)\\nDISTANCE_ENEMY>(500);RATE(60)\\nHP_I<(0.5);DISTANCE_ENEMY<(400);BUFF_I(4981,0,0);RATE(5)\\nGO(0)',
         'CHASE(1)\\nCHASE(2)\\nCHASE(3)\\nCHASE(1)'),
    ...
    301: ('HP_I<(0.3);RATE(15)\\nBUFF_I(4983,0,0);HP_I<(0.4);RATE(10)\\nBUFF_I(4982,0,0);DISTANCE_ENEMY<(750);RATE(35)\\nBUFF_I(4980,0,0);DISTANCE_ENEMY>(300);RATE(75)\\nGO(0)',
         'CHASE(5)\\nCHASE(4)\\nCHASE(3)\\nCHASE(2)\\nCHASE(1)'),
    315: ('BUFF_I(4983,0,0);HP_I<(0.9);RATE(30)\\nBUFF_I(4981,0,0);RATE(25)\\nRATE(30)\\nDISTANCE_ENEMY>(400);BUFF_I(4980,0,0);RATE(60)\\nGO(0)',
         'CHASE(4)\\nCHASE(3)\\nCHASE(1)\\nCHASE(2)\\nCHASE(1)'),
