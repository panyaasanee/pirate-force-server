...
class Scene14RegistryTests(unittest.TestCase):
    ...
    def test_the_other_ten_marker_doors_did_not_open_with_it(self):
        ...
        UPDATED round fx0007: scene 6 left this set the same way, fourth of
        the ten doors this lane has opened -- built, wired and opened in
        ...
        UPDATED round p7wm17: scene 3 left this set the same way, sixth of
        the ten doors this lane has opened -- built, wired and opened in
        ...
        UPDATED round 78zayw: scene 7 left this set the same way, seventh of
        the ten doors this lane has opened -- built, wired and opened in
        one round, same compressed shape as scenes 5's, 6's, 8's and 3's.
    ...
    def test_scene_6_opened_separately_and_that_is_a_different_round(self):
        """ADDED round fx0007: the fourth scene removed from the tuple above.

        Same reasoning as scene 4's, scene 10's and scene 5's sibling
        tests.  Like scene 5, scene 6 (Ocean Walled City) does NOT carry
        the elevated landing-geometry flag (``the_two_interiors``) --
        checked, not assumed, in ``world_bg0006_identity``'s own docstring.
        """
    ...
    def test_scene_3_opened_separately_and_that_is_a_different_round(self):
        """ADDED round p7wm17: the sixth scene removed from the tuple above.
    ...
    def test_scene_7_opened_separately_and_that_is_a_different_round(self):
        """ADDED this round (78zayw): the seventh scene removed from the
        tuple above.

        Same reasoning as scenes 4's, 10's, 5's, 6's, 8's and 3's sibling
        tests.  Like scenes 5, 6, 8 and 3, scene 7 (Voodoo Island) does NOT
        carry the elevated landing-geometry flag (``the_two_interiors``) --
        checked, not assumed, in ``world_bg0007_identity``'s own docstring.
        """
        target = world_scene_travel.destination(7, self.registry)
        self.assertTrue(target.login_entry_allowed)
    ...
    def test_scene_9_opened_separately_and_that_is_a_different_round(self):
        ...
        Sea) does NOT carry the elevated landing-geometry flag
        (``the_two_interiors``) -- checked, not assumed, in
        ``world_bg0009_identity``'s own docstring.
        """
