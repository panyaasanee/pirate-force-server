...
# shape.  Scene 3 joined it this round, sixth door, same shape -- and is
# therefore no longer a usable BARRED_ON_DISK example, so that constant
# moves to scene 7 (still shut, one of the four doors this lane has not
# yet opened).
ADMISSIBLE_ON_DISK_TODAY = (1, 2, 3, 4, 5, 6, 8, 10, 14, 278, 997)
# Named in the client's scene table (Voodoo Island) and pinned
