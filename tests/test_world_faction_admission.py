...
SLAVE_MARKET = 4
# ADDED round l03cgh (LANE-A): opened the same round this constant was added,
# third of the ten doors, built+wired+opened in one round -- no elevated
# landing-geometry flag on this row (checked, not assumed).
EVIL_PORT = 5
# ADDED round fx0007 (LANE-A): opened the same round this constant was
...
DEEP_SEA_TEMPLE = 10
# ADDED round p7wm17 (LANE-A): opened the same round this constant was
...
# elevated landing-geometry flag on this row (checked, not assumed).
VOODOO_ISLAND = 7
# ADDED round ir0lpw (LANE-A): opened the same round this constant was
...
class ThePredicateOnTheRealRegistryTests(unittest.TestCase):
    ...
    def test_the_admitted_set_is_exactly_the_two_proven_scenes_and_the_volcano(
        ...
        # UPDATED round l03cgh: scene 5 (EVIL_PORT) opened third, same
        # basis, also n_SAVE 1.
    ...
    def test_the_console_line_follows_a_registry_that_moves(self):
        ...
        # UPDATED round l03cgh: the base registry now also already admits
        # scene 5 (EVIL_PORT), one more digit that is not the one this test
        # opens.
        ...
        # test opens.
        # UPDATED round p7wm17: the base registry now also already admits
        ...
        # UPDATED round ir0lpw: the base registry now also already
