...
ร่วมกับฉาก 10 เท่านั้น)** จึงยังไม่ยืนยันว่าจุดเกิดยืนได้จริงหรือตกในหิน ต้องรอ GT-178 (attended)
...
- ไม่มีมนุษย์ยืนในฉากนี้มาก่อน จุดเกิด MARKER[11] ห่างจาก placement ที่ใกล้ที่สุด **1107.764 หน่วย** (อยู่ใน
  ...
  เปิด (คู่กับฉาก 10)** GT-178 เปิดแล้วใน pf_bridge/GAME_TEST_QUEUE.md เป็นแบบ dual-objective (มี
